...
abstract: This document provides additional information relating to each section and figure in the main article (<https://doi.org/10.1111/2041-210X.13059>). The document is written in R Markdown and the source file (.Rmd) is available at <https://github.com/torbjore/study_mortality_with_hazard_rates>. It contains all R-code needed to reproduce all figures and examples in this document (see <https://rmarkdown.rstudio.com/>).
---
