function (x, ddl, dml, model_data = NULL, parameters, accumulate = TRUE, 
    ...
    compile = FALSE, extra.args = "", clean = TRUE, ...) 
{
    ...
    if (is.null(convergence)) 
        convergence = 0
    res = read_admb(tpl)
    beta = list(unscale.par(c(res$coeflist$phibeta, res$coeflist$pbeta, 
